...
export class ReportNewPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public zone: NgZone,
    private camera : Camera, private alertCtrl: AlertController, private imageResizer: ImageResizer, private nativeGeocoder: NativeGeocoder,
  ...
  autoFillAddress() {
    ...
    this.nativeGeocoder.reverseGeocode(lat , lng).then((results: NativeGeocoderReverseResult[]) => {
